...
namespace xt
{
    ...
    // xarray variants of view_benchmarks_v2
    namespace view_benchmarks_v2_xarray
    {
        constexpr int SIZE = 2;
    ...
    namespace stencil_v2_xarray
    {
        ...
        BENCHMARK_CAPTURE(stencil_onedirection_v2, stencil_v2_onedirection_xarray_50, 3);
        BENCHMARK_CAPTURE(stencil_onedirection_v2, stencil_v2_onedirection_xarray_100, 3);
        BENCHMARK_CAPTURE(stencil_onedirection_v2, stencil_v2_onedirection_xarray_200, 3);
        BENCHMARK_CAPTURE(stencil_onedirection_v2, stencil_v2_onedirection_xarray_300, 3);
        BENCHMARK_CAPTURE(stencil_onedirection_v2, stencil_v2_onedirection_xarray_500, 3);

        BENCHMARK_CAPTURE(stencil_onedirection_v2_precomputed, stencil_v2_onedirection_precomputed_xarray_50, 3);
        BENCHMARK_CAPTURE(stencil_onedirection_v2_precomputed, stencil_v2_onedirection_precomputed_xarray_100, 3);
        BENCHMARK_CAPTURE(stencil_onedirection_v2_precomputed, stencil_v2_onedirection_precomputed_xarray_200, 3);
        BENCHMARK_CAPTURE(stencil_onedirection_v2_precomputed, stencil_v2_onedirection_precomputed_xarray_300, 3);
        BENCHMARK_CAPTURE(stencil_onedirection_v2_precomputed, stencil_v2_onedirection_precomputed_xarray_500, 3);

        BENCHMARK_CAPTURE(stencil_twodirections_v2, stencil_v2_twodirections_xarray_50, 3);
        BENCHMARK_CAPTURE(stencil_twodirections_v2, stencil_v2_twodirections_xarray_100, 3);
        BENCHMARK_CAPTURE(stencil_twodirections_v2, stencil_v2_twodirections_xarray_200, 3);
        BENCHMARK_CAPTURE(stencil_twodirections_v2, stencil_v2_twodirections_xarray_300, 3);
        BENCHMARK_CAPTURE(stencil_twodirections_v2, stencil_v2_twodirections_xarray_500, 3);

        BENCHMARK_CAPTURE(stencil_threedirections_v2, stencil_v2_threedirections_xarray_50, 3);
        BENCHMARK_CAPTURE(stencil_threedirections_v2, stencil_v2_threedirections_xarray_100, 3);
        BENCHMARK_CAPTURE(stencil_threedirections_v2, stencil_v2_threedirections_xarray_200, 3);
        BENCHMARK_CAPTURE(stencil_threedirections_v2, stencil_v2_threedirections_xarray_300, 3);
        BENCHMARK_CAPTURE(stencil_threedirections_v2, stencil_v2_threedirections_xarray_500, 3);
    }
}
